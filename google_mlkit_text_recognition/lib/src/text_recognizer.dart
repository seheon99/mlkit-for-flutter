...
class TextRecognizer {
  ...
  TextRecognizer({this.script = TextRecognitionScript.korean});
...
class RecognizedText {
  ...
  RecognizedText({required this.text,required this.blocks, required this.lines});
  ...
  factory RecognizedText.fromJson(Map<dynamic, dynamic> json) {
    ...
    return RecognizedText(text: resText, blocks: textBlocks,lines: textLines);
  }
}
